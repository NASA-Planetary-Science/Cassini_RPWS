...
DESCRIPTION             = "CUMINDEX.TAB is a cumulative index
  of all of the PDS label files corresponding to all of the
  archived Cassini RPWS data on this volume as well as previous
  volumes.  The first line of the cumulative index file contains
