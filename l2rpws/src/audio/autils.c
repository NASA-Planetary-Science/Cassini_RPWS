...
#ifdef __STDC__
int searchNameTable (char *pName, char *pTable[]
  )
#else
int searchNameTable (pName, pTable)
char *pName;
char *pTable[];
#endif
{
...
#ifdef __STDC__
AFileFormat findFormat (char *pString)
#else
AFileFormat findFormat (pString)
char *pString;
#endif
{
  int file_format;
...
#ifdef __STDC__
ADataFormat findDataFormat (char *pString)
#else
ADataFormat findDataFormat (pString)
char *pString;
#endif
{
  int data_format;
...
#ifdef __STDC__
unsigned long rate2num (char *rate)
#else
unsigned long rate2num (rate)
char *rate;
#endif
{
  int n, lastIndex;
...
#ifdef __STDC__
int
name2format (char *afile, AFileFormat * pFormat, unsigned long *pSampleRate)
#else
int name2format (afile, pFormat, pSampleRate)
char *afile;
AFileFormat *pFormat;
...
#ifdef __STDC__
void printAudioError (Audio * audio, char *message, int errorCode)
#else
void printAudioError (audio, message, errorCode)
Audio *audio;
char *message;
int errorCode;
#endif
