...
int mcmd_help (void)
{
  if (fg_flag ("help") || fg_flag ("help")) {
    fprintf (stderr, " mcmd help   (%s)\n", version);
...
#ifdef __RPWSHP2__
    fprintf (stderr, "     -delay nn change delay between GPIB\n");
    fprintf (stderr, "                 operations (default 250 mS)\n");
#endif
