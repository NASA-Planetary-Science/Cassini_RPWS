...
static char *title = { " CASSINI MP data dump  (DSP5) 5.102" };
...
int status_wbr (unsigned char *mp, int ipos)
{
  ...
  u_print0 (vert++, 0, string);
  sprintf (string, "ST_WBR cmprs:%s, MSF:%s, Ant:%s, AGC:0x%2.2X       ", st_wfr (22, (mp[6] >> 4) & 0x0F),     /* 12/2001 was 0xF0 */
           st_wfr (6, (mp[6] >> 3) & 0x01),     /* 12/2001 was 0x08 */
