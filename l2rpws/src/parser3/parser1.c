...
void print_help (void)
{
  ...
  fprintf (stderr, "\t-ieb           Generates assembler lines (%s).\n",
           defw);
  fprintf (stderr, "\t-ieb xxx         assembler lines with label.\n");
  fprintf (stderr, "\t-pagelength n  Set desired page width\n");
  fprintf (stderr, "\t-pagewidth n   Set desired page width\n");
  fprintf (stderr, "\t-avocet xxx    AVOCET assembler. (xxx is label)\n");
  fprintf (stderr,
           "\t-masm xxx      Microsoft MASM assembler. (xxx is label)\n");
  fprintf (stderr, "\t-batch n       Appends 's' after every n words.\n");
